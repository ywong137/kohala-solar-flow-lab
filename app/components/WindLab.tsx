        ...
        <div className="modal-backdrop" role="presentation" onMouseDown={() => setShowAssumptions(false)}>
          <section className="modal assumptions-modal" role="dialog" aria-modal="true" aria-label="Model assumptions" onMouseDown={(event) => event.stopPropagation()}>
            ...
            <div className="assumption-grid">
              ...
              <article><span>05</span><h3>Estimated rack and site</h3><p>The rack uses a {geometryMetrics.tableChordM.toFixed(2)} m maximum slope and {geometry.lowEdgeClearanceM.toFixed(2)}–{geometryMetrics.highEdgeClearanceM.toFixed(2)} m clearance. The curved volcanic rock wall rises at its center. The retained hill meets its upper edge.</p></article>
              <article><span>09</span><h3>Immediate damage</h3><p>The default photo inventory has 55 visible front panels: 36 in place and 19 displaced. It treats 29 unseen panels as blown off-site. All racks remain installed.</p></article>

        ...
        <div className="modal-backdrop" role="presentation" onMouseDown={() => setShowAssumptions(false)}>
          <section className="modal assumptions-modal" role="dialog" aria-modal="true" aria-label="Model assumptions" onMouseDown={(event) => event.stopPropagation()}>
            ...
            <div className="assumption-grid">
              ...
              <article><span>05</span><h3>Estimated rack and site</h3><p>The rack uses a {geometryMetrics.tableChordM.toFixed(2)} m maximum slope and {geometry.lowEdgeClearanceM.toFixed(2)}–{geometryMetrics.highEdgeClearanceM.toFixed(2)} m clearance. The volcanic rock retaining wall sits about 3.0 m beyond the southeast panel ends. The rounded hill rises higher toward the rear.</p></article>
              <article><span>09</span><h3>Immediate damage</h3><p>The surviving racks remain in their installed positions. The immediate view omits panels that the photographs show blew beyond the modeled area.</p></article>
